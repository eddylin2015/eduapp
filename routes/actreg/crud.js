...
router.get('/add', (req, res) => {
    if(!checkuser(req)){ res.end("no right");return;}
    let formpug='actreg/form.pug';
    if(req.query.ckedit) formpug='actreg/form.1.pug';
    res.render(formpug, {
        profile: req.user,
        book: {
            author: req.user.username,
