CREATE TABLE `stdsportitem` (
  ...
  `publishedDate` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  ...
  `createdById` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
CREATE TABLE `tblgr` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `si_id` varchar(45) COLLATE utf8_bin DEFAULT NULL,
  `gr_rc` varchar(45) COLLATE utf8_bin DEFAULT NULL,
  `name` varchar(45) COLLATE utf8_bin DEFAULT NULL,
  `classno` varchar(45) COLLATE utf8_bin DEFAULT NULL,
  `gr_period` varchar(45) COLLATE utf8_bin DEFAULT NULL,
  `gr_date` varchar(45) COLLATE utf8_bin DEFAULT NULL,
...
CREATE TABLE `sport_item` (
  ...
  `plist` text CHARACTER SET utf8 COLLATE utf8_bin
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
ALTER TABLE `sport_item` ADD COLUMN `name_ctx` TEXT NULL ;
ALTER TABLE `sport_item` ADD COLUMN `rc_ctx` TEXT NULL ;
