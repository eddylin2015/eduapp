...
//showClassTag : x: ClassName; switch Dislay : [none,block]
function showClassTag(x, tbl, searchby="classname") {
   if (x == "all") {
...
// 匯出CSV 例子:exportTableToCSV: a.export(href="#") Export Table data into CSV Example:
//$(document).ready(function() {
//    $(".export").on('click', function(event) {
//      exportTableToCSV.apply(this, [$('#tableContent>table'), 'export0.csv'] );
//    });
//});
//a.export, a.export:visited { display: inline-block;   text-decoration: none; color:#000; padding:8px; background-color:#ddd; border: 1px solid #ccc;}
